...
// terraform plan or apply -var-file="Staging-Env-terraform.tfvars"

//then varable value consider from "Staging-Env-terraform.tfvar" instead of any other variable value.